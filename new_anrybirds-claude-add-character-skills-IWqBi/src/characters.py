...
class Bird():
    ...
    def __init__(self, distance, angle, x, y, space, bird_type=0):
        ...
        self.is_skill_bird = bird_type in [Bird.YELLOW, Bird.BLUE, Bird.ORANGE, Bird.PINK]  # 需要技能的鸟
        self.skill_active = False  # 技能是否已触发
        self.to_remove = False     # 是否该移除
        # 基础属性
        mass = 5
        radius = 12
        self.radius = radius
    ...
    def activate_special(self):
        """触发特殊技能"""
        if not self.is_skill_bird or self.skill_active:
            return
        self.activated = True
